...
\begin{textblock}{5}(0,0)
	...
	%\vspace{10mm}
	\includegraphics [scale=0.6]{couvertures/bande.png}
	\vspace{300mm}
\end{textblock}

\begin{textblock}{1}(0.6,9.5)

	\huge{\rotatebox{90}{\color{white}{\fontsize{35}{50}\selectfont Thèse de doctorat}}}
\end{textblock}

\begin{textblock}{1}(0.6,3)
	\Large{\rotatebox{90}{\color{white}{NNT \string: \NNT}}}
\end{textblock}


\begin{textblock}{1}(\hpostt,\vpostt)
	\textblockcolour{white}
	\includegraphics[width=1mm]{couvertures/etab/\logoEtt.png}
\end{textblock}

\begin{textblock}{3}(\hpos,\vpos)
	\textblockcolour{white}
...
%\vspace{6cm}
%% Texte
% \begin{textblock}{largeur}(H_position, v_position) in strang unites
% \begin{textblock}{10.3}(5.4,3) % for b5
\begin{textblock}{10.0}(5.4,3)  %for A'
	\textblockcolour{white}
  ...
  \vspace{1cm}
	...
	\begin{flushright}
		...
		\small{Spécialité de doctorat\string: \PhDspeciality} \bigskip %% Spécialité
		\vfill
		\footnotesize{Thèse présentée et soutenue à \defenseplace, le \defensedate, par} \bigskip
		\vfill
		\Large{\textbf{\color{red!60!black}{\PhDname}}} %% Nom du docteur
		\vfill
		%\bigskip
	\end{flushright}
  ...
  \vspace{2cm}
	...
	\begin{flushleft}
		...
		\small Composition du Jury \string:
	\end{flushleft}
	%% Members of the jury
